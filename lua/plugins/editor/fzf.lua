...
return {
  ...
  },
  {
    ...
    opts = function()
      -- stylua: ignore
      vim.keymap.set('n', 'gd', '<cmd>FzfLua lsp_definitions     jump1 silent=true ignore_current_line=true<cr>', { desc = "Goto Definition" })
      -- stylua: ignore
      vim.keymap.set('n', 'gr', '<cmd>FzfLua lsp_references      jump1 silent=true ignore_current_line=true<cr>', { desc = "References", nowait = true })
      -- stylua: ignore
      vim.keymap.set('n', 'gI', '<cmd>FzfLua lsp_implementations jump1 silent=true ignore_current_line=true<cr>', { desc = "Goto Implementation" })
      -- stylua: ignore
      vim.keymap.set('n', 'gy', '<cmd>FzfLua lsp_typedefs        jump1 silent=true ignore_current_line=true<cr>', { desc = "Goto Type Definitions" })
    end,
  },
}
